...
const AgentSystem: React.FC = () => {
  ...
  const agents: Agent[] = [
    ...
    },
    {
      ...
      name: '李书记',
      role: '执行协调专员',
      description: '负责将决策转化为具体的执行计划，协调资源分配，跟踪执行进度。',
      capabilities: ['任务分解', '资源调度', '进度跟踪', '协调沟通', '执行监控'],
      icon: Settings,
    ...
    },
    {
      ...
      name: '大治理官',
      role: '系统治理与优化官',
      description: '监控系统整体健康状况，进行性能调优，推动系统持续演进和改进。',
      capabilities: ['系统监控', '性能调优', '瓶颈分析', '容量规划', '演进规划'],
      icon: BarChart3,
