...
const PDFAnalysis: React.FC = () => {
  ...
  const handleExtractText = async () => {
    ...
    try {
      ...
      const extractedText = result.full_text || result.text || result.content || result.extracted_text || '';
      ...
      setAnalysisResult({
        ...
        keyPoints: result.key_points || ['暂无关键要点'],
        entities: result.entities || [{ text: '暂无实体', type: 'UNKNOWN', confidence: 0.0 }]
      });
