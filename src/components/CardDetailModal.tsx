...
import { X, ChevronRight, ExternalLink, Share2, Edit2, Trash2, Clock, Lightbulb, Plus, Link2, ArrowLeft, ArrowRight, BarChart3, ListTodo, Calendar, MapPin, Maximize2, Minimize2, Copy, ZoomIn, ZoomOut, FileText, Download, ChevronDown, FilePen, FileType, FileSpreadsheet, Link, Network, Loader } from 'lucide-react';
              ...
              <div className="flex items-center gap-2">
                ...
                {sourceFileInfo && sourceFileInfo.has_source && (
                  <div className="relative group">
                    ...
                    {/* 下拉菜单 */}
                    <div className="absolute right-0 top-full mt-1 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-lg shadow-xl z-50 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all min-w-[160px]">
                      <button
                        onClick={() => {
                        ...
                        className="w-full text-left text-xs px-3 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-t-lg flex items-center gap-2 text-gray-700 dark:text-gray-300"
                      >
                        <Download size={12} />
                        下载原始文件
                      </button>
