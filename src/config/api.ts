...
export const API_ENDPOINTS = {
  ...
  // 知识管理
  DATA_KNOWLEDGE-SPACES: '/api/data/knowledge-spaces',
  ...
  // 数据分析
  ANALYSIS_ANALYZE-EXISTING: '/api/analysis/analyze-existing',
  ANALYSIS_BATCH-ANALYZE: '/api/analysis/batch-analyze',
  ANALYSIS_DEMO-DATA: '/api/analysis/demo-data',
  ANALYSIS_DOWNLOAD_FILENAME: '/api/analysis/download/{filename}',
  ANALYSIS_LIST-ANALYSES: '/api/analysis/list-analyses',
  ANALYSIS_UPLOAD-AND-ANALYZE: '/api/analysis/upload-and-analyze',
  ...
  // 技能系统
  SKILL_BATCH-EXECUTE: '/api/skill/batch-execute',
  ...
  NPU_TEST-ROUTER: '/api/npu/test-router',
  ...
  DATA_GTD-TASKS: '/api/data/gtd-tasks',
  DATA_GTD-TASKS_TASK_ID: '/api/data/gtd-tasks/{task_id}',
  DATA_TEAM-MEMBERS: '/api/data/team-members',
  DATA_TEAM-MEMBERS_MEMBER_ID: '/api/data/team-members/{member_id}',

  // 文档处理
  EXCEL_DELETE_FILENAME: '/api/excel/delete/{filename}',
  EXCEL_DOWNLOAD_FILENAME: '/api/excel/download/{filename}',
  EXCEL_EXPORT-ANALYSIS: '/api/excel/export-analysis',
  EXCEL_EXPORT-CARDS: '/api/excel/export-cards',
  ...
  PPT_CARD-TYPES: '/api/ppt/card-types',
...
export const API_METHODS = {
  ...
  AGENT_STATS: ['GET'],
  AGENT_STATUS: ['GET'],
  ANALYSIS_ANALYZE-EXISTING: ['POST'],
  ANALYSIS_BATCH-ANALYZE: ['POST'],
  ANALYSIS_DEMO-DATA: ['GET'],
  ANALYSIS_DOWNLOAD_FILENAME: ['GET'],
  ANALYSIS_LIST-ANALYSES: ['GET'],
  ANALYSIS_UPLOAD-AND-ANALYZE: ['POST'],
  ...
  DATA_GTD-TASKS: ['GET', 'POST'],
  DATA_GTD-TASKS_TASK_ID: ['PUT', 'DELETE'],
  DATA_KNOWLEDGE-SPACES: ['GET', 'POST'],
  DATA_TEAM-MEMBERS: ['GET', 'POST'],
  DATA_TEAM-MEMBERS_MEMBER_ID: ['PUT', 'DELETE'],
  EXCEL_DELETE_FILENAME: ['DELETE'],
  EXCEL_DOWNLOAD_FILENAME: ['GET'],
  EXCEL_EXPORT-ANALYSIS: ['POST'],
  EXCEL_EXPORT-CARDS: ['POST'],
  EXCEL_LIST: ['GET'],
