...
try:
    ...
    print(f"[WARN] �����Ȳ��ϵͳ��ʼ��ʧ��: {e}")
register_router("routes.skill_hotplug_routes")  # �����Ȳ�ι���
register_router("routes.chain_word_routes")  # ���ʻ���
...
try:
    ...
    print(f"[WARN] ������ȡ����ʼ��ʧ��: {e}")
register_router("routes.ppf_routes")  # PPF �Զ�����������
