...
class DatabaseConfig(BaseConfig):
    ...
    # 数据库路径
    DB_PATH: Path = Field(default_factory=lambda: Path(__file__).parent.parent / "data" / "antinet.db")
    DB_VECTOR_PATH: Path = Field(default_factory=lambda: Path(__file__).parent.parent / "data" / "vector.db")
